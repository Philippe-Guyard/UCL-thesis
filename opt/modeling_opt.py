...
class OPTDecoderLayer(nn.Module):
    def __init__(self, config: OPTConfig, layer_num: int):
        super().__init__()
    ...
    def forward(
        ...
        """
        sample_id = SampleIds.cur_sample_id
        data_dir = Path(f'./data/block{self.layer_num}/{sample_id}')
        ...
        Timer.register(f'Decoder Layer {self.layer_num}')

        residual = hidden_states

        Timer.register('Self Attention')
        ...
        Timer.commit('MLP')
        Timer.commit(f'Decoder Layer {self.layer_num}')
...
class OPTDecoder(OPTPreTrainedModel):
    ...
    def __init__(self, config: OPTConfig):
        ...
        self.layers = nn.ModuleList([OPTDecoderLayer(config, k) for k in range(config.num_hidden_layers)])
